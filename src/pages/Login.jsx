      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-xs tracking-[0.2em] text-chalkdim uppercase">Hoops Tracker</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-panel border border-line rounded-lg p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-panel2 border border-line rounded-md px-3 py-2 text-chalk focus:border-amber outline-none"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-amber text-court font-semibold rounded-md py-2.5 hover:bg-amber/90 transition disabled:opacity-60"
          >
